...
const PlaceOrder = ({ category }) => {
    ...
    const placeorder = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://dhaneri-backend-7nkti8s6z-zeshs-projects.vercel.app/api/storefront/store/6874da6ef34b88733c0b452c/orders", orderData, {
                headers: {
