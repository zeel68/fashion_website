    ...
    return (
        <div className="fixed inset-0 bg-[rgba(0,0,0,0.8)] z-50 flex justify-center items-center">
            <div className="relative w-[40%] sm:w-[400px] bg-white p-10 shadow-lg rounded-md z-70">
                ...
                <p className='text-[13px] font-semibold pt-2'>for a quicker checkout</p>
                ...
                {state.toLowerCase() === "signup" && (
                    <input
                        ...
                        className='mt-1 text-[#6d6d6d] text-[14px] border border-[#ececec] w-full mb-3 p-2 outline-none rounded-md'
                        type="text"
                ...
                <button
                    ...
                    className='mt-3 bg-[#d4b952] text-white text-center text-sm py-2 w-full rounded-md'>
                    Continue
                </button>
                ...
                <div className="relative text-center my-6">
                    ...
                    <span className="relative inline-block bg-white px-4 text-[14px] text-gray-500 z-10">Or continue with</span>
                </div>
