                ...
                <div className="max-w-screen-xxl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-wrap align-middle justify-between">
                        ...
                        <ul className='flex flex-wrap text-center'>
                            ...
                            <li onClick={() => navigate('/myorder')} className='flex items-center justify-center text-center mx-2 my-2'>
                                <Link className='hover:text-[#d4b952] text-[#adadad] py-[11px] px-[30px] flex flex-col items-center'><MdLocalShipping size={30} className='text-[17px] mb-[5px]' />My Order</Link>
                            </li>
                            <li className='flex items-center justify-center text-center mx-2 my-2'>
